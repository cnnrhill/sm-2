M-2 algorithm calculates the number of days to wait before reviewing a piece of information based on how easily the user remembered the information today. 
